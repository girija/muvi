  ...
  (function($, window) {
    ...
    Tour = (function() {
      ...
      Tour.prototype._showPopover = function(step, i) {
        ...
        nav = [];
        if (step.prev >= 0) {
          nav.push("<a href='#" + step.prev + "' class='prev btn btn-info btn-mini bold_class'>" + options.labels.prev + "</a>");
        }
        if (step.next >= 0) {
          nav.push("<a href='#" + step.next + "' class='next btn btn-info btn-mini bold_class'>" + options.labels.next + "</a>");
        }
        //content += nav.join(" | ");
	content += nav.join(" ");
        //content += "<a href='#' class='pull-right end btn btn-warning btn-mini bold_class'>" + options.labels.end + "</a>";
        if(step.next == -1){
		content += "<a href='#' class='pull-right end btn btn-warning btn-mini bold_class'>" + options.labels.end + "</a>";
        }
        else{
