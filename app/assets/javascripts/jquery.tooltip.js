...
(function($) {
   ...
   $.fn.tooltip = function(settings) {
     ...
     function _show(target_elm) {
       ...
       var scrollTop  = $(window).scrollTop(), elementOffset = $(target_elm).offset().top, distance  = (elementOffset - scrollTop);
       if(distance < 80){
        is_top = false;
        is_bottom = true;
       }
     ...
     function _create(content_elm) {
       ...
       return $("<div class='jquery-gdakram-tooltip'>\
         ...
         <div class='content' style='width:" + width + "'>" + header + $(content_elm).html() + "</div>\
